...
\begin{frame}{Move}
\begin{center}
%\includegraphics[width=0.90\linewidth]{images/SSDMove}
\end{center}
\end{frame}
...
\begin{center}
%\includegraphics[width=0.90\linewidth]{images/SSDPickUpItem}
\end{center}
\end{frame}
...
\begin{center}
%\includegraphics[width=0.90\linewidth]{images/SSDEndTurn}
\end{center}
\end{frame}
