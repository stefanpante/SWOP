...
//
//import items.launchable.ChargedDisc;
...
//
//		Square next = game.getGrid().getNeighbor(currentPlayer.getPosition(), direction);
//		ChargedDisc id = new ChargedDisc();
//		next.getInventory().addItem(id);
//
//		// Make sure that there are no powerfailures
//		game.clearPowerFailures();
...
//
//		// new identity disc
//		ChargedDisc id2 = new ChargedDisc();
//		// Player should have identitydisc in inventory
...
//
//		// new identity disc
//		ChargedDisc id3 = new ChargedDisc();
//		// Player should have identitydisc in inventory
...
//
//		// new identity disc
//		ChargedDisc id4 = new ChargedDisc();
//		// Player should have identitydisc in inventory
