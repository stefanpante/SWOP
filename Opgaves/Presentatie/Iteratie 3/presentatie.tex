...
Coverage geeft een goed percentage. Hiermee moet de GUI mee in beschouwing worden genomen want deze code is zeer groot (25\%) en wordt niet getest.
\begin{center}
\includegraphics[scale=0.3]{images/coverage}
\end{center}
\end{frame}
